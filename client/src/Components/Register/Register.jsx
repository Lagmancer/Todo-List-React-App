    ...
    try {
      ...
      Swal.fire({
        ...
        text:
          ...
          "Something went wrong, account creation failed",
      });
    }
  };
  ...
  return (
    ...
    >
      <div className="w-1/2 relative h-screen flex items-end">
        <img
          className="mr-[50%] w-[70%] h-[90%] object-contain"
          src={"/Register/Image.png"}
          alt="Image"
        />
      </div>
      <div className="w-1/2 px-12 py-5 h-screen">
        <h2 className="font-montserrat text-4xl font-bold mb-8 mt-6">
          Sign Up
        </h2>
        <form className="h-[80%]" onSubmit={handleSubmit}>
          <div className="mb-2 h-[12.5%] relative">
            ...
            <input
              ...
              className="input-firstname w-full px-3 py-2 border rounded-md border-gray-500 h-[80%] text-xs"
              style={{
          ...
          <button className="w-1/4 h-[12.5%] bg-red-600 text-white py-2 border rounded-md opacity-50 hover:opacity-100 cursor-pointer transition-all duration-300">
            Register
          </button>
        </form>
