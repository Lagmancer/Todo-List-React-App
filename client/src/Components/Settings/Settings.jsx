...
const Settings = ({user, setUser}) => {
  ...
  const handleFileChange = async (e) => {
    ...
    try {
      ...
      const res = await axios.put("http://localhost:3000/auth/upload-profile-picture", formData, {
        headers: {
  ...
  return (
    <div className="m-0 p-0 h-screen w-screen relative" style={{ fontFamily: "Inter, sans-serif" }}>
      ...
      >
        ...
        {activeForm === "info" && (
          <form className="h-[100%]" style={{ fontFamily: "Montserrat, sans-serif" }}>
            <div className="mb-6 h-[12%] w-[60%] relative">
              <label htmlFor="firstname" className='block text-black-700 font-semibold text-sm mb-1'>First Name</label>
              <input type="text" 
            ...
            <div className="mb-6 h-[12%] w-[60%] relative">
              <label htmlFor="lastname" className='block text-black-700 font-semibold text-sm mb-1'>Last Name</label>
              <input type="text" 
              value={user?.lastname || ""}  
              className='w-full px-3 py-2 border-2 rounded-md border-gray-300 h-[80%] text-xs'
                style={{
            ...
            <div className="mb-6 h-[12%] w-[60%] relative">
              <label htmlFor="email" className='block text-black-700 font-semibold text-sm mb-1'>Email Address</label>
              <input type="text" 
              value={user?.email || ""}  
              className='w-full px-3 py-2 border-2 rounded-md border-gray-300 h-[80%] text-xs'
                style={{
            ...
            <div className="mb-6 h-[12%] w-[60%] relative">
              <label htmlFor="contactnumber" className='block text-black-700 font-semibold text-sm mb-1'>Contact Number</label>
              <input type="text" 
            ...
            <div className="mb-6 h-[12%] w-[60%] relative">
              <label htmlFor="position" className='block text-black-700 font-semibold text-sm mb-1'>Position</label>
              <input type="text" 
              value={user?.position || ""}  
              className='w-full px-3 py-2 border-2 rounded-md border-gray-300 h-[80%] text-xs'
                style={{
            ...
            className="w-1/6 mr-2 h-[10%] bg-[#F24E1E] text-white py-2 border rounded-md opacity-90 hover:opacity-100 cursor-pointer transition-all duration-300">Update Info</button>
            <button 
            type="button"
            onClick={() => setActiveForm("changePassword")}
            className="w-1/5 h-[10%] bg-[#F24E1E] text-white py-2 border rounded-md opacity-90 hover:opacity-100 cursor-pointer transition-all duration-300">Change Password</button>
          </form>
        )}
        ...
        {activeForm === "updateInfo" && (
          <form className="h-[100%]" style={{ fontFamily: "Montserrat, sans-serif" }}>
            ...
            className="w-[20%] mr-2 h-[10%] bg-[#F24E1E] text-white py-2 border rounded-md opacity-90 hover:opacity-100 cursor-pointer transition-all duration-300">Save Changes</button>
            <button 
            type="button"
            onClick={() => setActiveForm("info")}
            className="w-[13%] mr-2 h-[10%] bg-[#F24E1E] text-white py-2 border rounded-md opacity-90 hover:opacity-100 cursor-pointer transition-all duration-300">Cancel</button>
          </form>
        )}
        ...
        {activeForm === "changePassword" && (
          <form className="h-[100%]" style={{ fontFamily: "Montserrat, sans-serif" }}>
            <div className="mb-6 h-[12%] w-[60%] relative">
              <label htmlFor="currentpassword" className='block text-black-700 font-semibold text-sm mb-1'>Current Password</label>
              <input type="password" 
            ...
            <div className="mb-6 h-[12%] w-[60%] relative">
              <label htmlFor="newpassword" className='block text-black-700 font-semibold text-sm mb-1'>New Password</label>
              <input type="password" 
            ...
            <div className="mb-6 h-[12%] w-[60%] relative">
              <label htmlFor="confirmpassword" className='block text-black-700 font-semibold text-sm mb-1'>Confirm Password</label>
              <input type="password" 
            ...
            className="w-[20%] mr-2 h-[10%] bg-[#F24E1E] text-white py-2 border rounded-md opacity-90 hover:opacity-100 cursor-pointer transition-all duration-300">Update Password</button>
            <button 
            type="button"
            onClick={() => setActiveForm("info")}
            className="w-[13%] mr-2 h-[10%] bg-[#F24E1E] text-white py-2 border rounded-md opacity-90 hover:opacity-100 cursor-pointer transition-all duration-300">Cancel</button>
