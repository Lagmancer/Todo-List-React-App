    ...
    <div className="m-0 p-0 h-screen w-screen flex justify-center items-center h-screen bg-cover bg-center bg-[url('/Register/Background.png')]">
      <div className='w-1/2 px-12 py-5 h-screen'>
        ...
        <form className="h-[40%]" onSubmit={handleSubmit}>
          ...
          <button className="w-1/4 h-[25.5%] bg-red-600 text-white py-2 border rounded-md opacity-50 hover:opacity-100 cursor-pointer transition-all duration-300">Login</button>
        </form>
        ...
        <div className="text-sm mt-3">
          ...
          <Link to='/register' className='text-blue-500'>Create One</Link>
        </div>
      </div>
      <div className = "w-1/2 relative h-screen flex items-end">
              <img className = "w-[100%] h-[70%] object-contain" src={"/Login/Image.png"} alt="Image" />
        </div>
    </div>
  )
}
